...
#         self.conv1 = conv_seq_without_dropout(input_channel, 16)
#         self.conv2 = conv_seq_without_dropout(16, 32)
#         self.conv3 = conv_seq_without_dropout(32, 64)
#         self.conv4 = conv_seq_without_dropout(64, 128)
#         self.conv5 = conv_seq(128, 256)

#         self.conv6 = conv_seq(256,512)

#         self.upconv5 = up_conv_seq(512,256)
#         self.attn5 = Attention_block(F_g=256,F_l=256,F_int=128)
#         self.conv5_ = conv_seq_without_dropout(512,256)

#         self.upconv4 = up_conv_seq(256,128)
#         self.attn4 = Attention_block(F_g=128,F_l=128,F_int=64)
#         self.conv4_ = conv_seq_without_dropout(256,128)

#         self.upconv3 = up_conv_seq(128,64)
#         self.attn3 = Attention_block(F_g=64,F_l=64,F_int=32)
#         self.conv3_ = conv_seq_without_dropout(128,64)

#         self.upconv2 = up_conv_seq(64,32)
#         self.attn2 = Attention_block(F_g=32,F_l=32,F_int=16)
#         self.conv2_ = conv_seq_without_dropout(64,32)

#         self.upconv1 = up_conv_seq(32,16)
#         self.attn1 = Attention_block(F_g=16,F_l=16,F_int=8)
#         self.conv1_ = conv_seq_without_dropout(32,16)
...
#         x5 = self.conv5(p4)
#         p5 = self.maxpool_(x5) # 6, 4, 6

#         x = self.conv6(p5) # 6, 4, 6

#         x6 = self.upconv5(x)
#         x6 = self.upsample_(x6) # 6, 8, 12
#         x5 = self.attn5(x6,x5)
#         x6 = torch.cat([x6, x5], dim=1)
#         x6 = self.conv5_(x6)
